export const ORDER_STATUS_STYLES: Record<string, { label: string; className: string }> = {
  SCHEDULED: { label: "Scheduled", className: "bg-cream-100 text-ink-muted border-border" },
  ...
  PAUSED: { label: "Paused", className: "bg-cream-100 text-ink-muted border-border" },
}

export const ACCOUNT_STATUS_STYLES: Record<string, { label: string; className: string }> = {
  PROVISIONAL: { label: "Provisional", className: "bg-cream-100 text-ink-muted border-border" },
